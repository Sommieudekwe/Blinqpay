      ...
      <div className="w-[35rem] mx-auto rounded-xl bg-onboard-bg border border-white py-10 px-[1.875rem] border-opacity-25">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="w-full mt-[3.375rem] ">
                ...
                render={({ field }) => (
                  <FormItem className="flex space-x-3 space-y-0">
                    ...
                    <FormDescription className="mt-0">
                      Terms and conditions guiding this information privacy policy and all will be here and by clicking submit you agree to this privacy policy
                    </FormDescription>
                  </FormItem>
                )}
              />
            ...
            <p className="font-medium text-typography text-center mt-6">Can’t find your secret key, API Key or User ID? <Link href={'/'} className="text-button-primary">Watch this video</Link></p>
          </form>
        </Form>
      </div>
