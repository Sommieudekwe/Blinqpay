...
export default function Connectivity()
{
  ...
  return (
    <section className="w-full h-full lg:pt-16">
      ...
      <div className="w-full max-w-[42rem] mx-auto rounded-xl bg-onboard-bg border border-white px-10 py-5 border-opacity-25 flex justify-between">
        <div className="profile flex h-[2.938rem] w-auto space-x-7">
          <div className="flex space-x-2">
            ...
            <div className="h-[2.938rem]">
              ...
              <p className="text-white font-medium opacity-40">
                Merchant
              </p>
            </div>
          </div>

          <Image width={76} height={26} src={"/dashboard/settings/level1.svg"} alt={"badge"} />
        </div>
      ...
      <div className="w-full max-w-[42rem] mx-auto rounded-xl bg-onboard-bg border border-white px-10 py-5 border-opacity-25 mt-5 space-y-4">
        {
      ...
      <Dialog open={isSuccess} onOpenChange={setIsSuccess}>
        <DialogContent className=" text-left text-white">
          <div className="inline-flex justify-between">
            ...
            <Image src={'/dashboard/settings/x.svg'} alt="cancle" width={45} height={45} />
          </div>
